...
namespace TripTogether.Domain.Migrations
{
    ...
    [Migration("20260319090802_PollOption-IsSelectFinalized2")]
    partial class PollOptionIsSelectFinalized2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PollOption", b =>
                {
                    ...
                    b.Property<bool>("IsSelectFinalized")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("is_select_finalized");
